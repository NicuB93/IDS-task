export const sectionContent = {
  imgTitle: "Lord Voldemort",
  imgDescription:
    "Vice-President for Knowledge Management and Sustainable Development Activities",
  email: "lordVoldemort@example.com",
  messageTitle: "IDS’s Message",
  messageHeader: `Knowledge management has always been intertwined with the work of
  ...
  messageContent: `
    ...
    ultricies enim at dolor porta, at malesuada lorem luctus.
    `,
};
